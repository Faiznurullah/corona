...
<center><h2 class="mb-5">Live Data Covid-19 Dunia</h2></center>
          ...
          <div class="row">
            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Data Table Global:</h6>
              </div>
              <!-- Card Body -->
              <div class="card-body">
